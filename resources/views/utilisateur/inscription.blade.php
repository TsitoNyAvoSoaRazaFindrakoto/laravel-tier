...
<div class="login-card" ng-app="inscriptionApp" ng-controller="inscriptionController">
    ...
    <form ng-submit="submitForm()">
        ...
        <input ng-model="passwordTest" type="password" class="form-control" placeholder="Confirmer mot de passe" required>
        <button type="submit" id="buttonLogin" class="btn btn-login">S'inscrire</button>
    </form>
</div>
