...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/connection') }}">Se connecter</a>
          </li>
          <li class="nav-item">
            <a class="btn btn-signup" href="{{ url('/inscription') }}">S'incrire</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="hero">
    ...
    <a href="{{ url('/connection') }}" class="btn btn-start">Découvrir Plus</a>
  </section>
