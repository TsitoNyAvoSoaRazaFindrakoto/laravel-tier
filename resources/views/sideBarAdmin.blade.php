...
<li class="nav-item">
    ...
    <div class="collapse" id="transaction">
        <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ url('/transaction/historique') }}">Voir les
                    historiques</a></li>
        </ul>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div class="collapse" id="dashboard">
        <ul class="nav flex-column sub-menu">
            <li class="nav-item"><a class="nav-link" href="{{ url("dashboard") }}">Evolution graphique</a>
            </li>
            <li class="nav-item"><a class="nav-link" href="{{ url("dashboard/parametre") }}">Parametre des
                    commissions</a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="{{ url("dashboard/porte-feuille") }}">Liste des porte
                    feuille</a></li>
        </ul>
    </div>
</li>
